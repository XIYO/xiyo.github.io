...
<style>
	...
	:global(body:has(#nav-toggle:checked)) {
		:global(#border-outer-nav > #border-inner-nav) > label > span:last-child > svg {
			rotate: 180deg;
		}
	}
	...
	@media (min-width: 426px) {
		...
		:global(#border-outer-nav > #border-inner-nav) > label > span:last-child {
	...
	@media (max-width: 425px) {
		:global(body) {
			:global(#border-outer-nav) {
				...
				:global(& > #border-inner-nav) > label > span:last-child {
